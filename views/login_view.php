  ...
  <body>
    ...
    <div class="grid_login ">
    	<div class="grid_title d-flex justify-content-center align-items-center">
          ...
          <a href="<?php echo base_url(); ?>index.php/elfeisbuc_controller/registro" class="btn btn-warning shadow rounded-0 mt-5">Registrarse</a>
        </div>
    	</div>
	    <form class="form-signin">
	      ...
	      <input type="text" id="user_login" name="user_login" class="form-control rounded-0" placeholder="Usuario" required autofocus>
	      <label for="pass_login" class="sr-only">Contraseña</label>
	      <input type="password" id="pass_login" name="pass_login" class="form-control rounded-0 mt-3" placeholder="Contraseña" required>
	      <button class="btn btn-lg btn-feisbuk btn-block rounded-0" type="submit">Entrar</button>
  ...
  <body>
    ...
    <div class="grid_login">
      ...
      ?>"
	      ...
	      <label for="user_login" class="sr-only">User</label>
	      <input type="text" name="user_login" id="user_login" class="form-control rounded-0" placeholder="Nick" required autofocus>
	      <label for="pass_login" class="sr-only">Password</label>
	      <input type="password" name="pass_login" id="pass_login" class="form-control rounded-0 mt-3" placeholder="Password" required>
